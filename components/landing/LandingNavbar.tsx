    ...
    <nav className="fixed top-0 left-0 right-0 z-40 backdrop-blur-md bg-white/40 border-b border-white/50">
      <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <button
          ...
          className="md:hidden backdrop-blur-md bg-white/40 border border-white/50 rounded-full p-3 text-foreground hover:bg-white/60 hover:border-primary/40 hover:shadow-lg hover:shadow-primary/30 transition-all duration-300"
              ...
              {isLoggedIn ? (
                <>
                  ...
                  <button
                    ...
                    className="backdrop-blur-md bg-white/40 border border-white/50 rounded-xl py-3 px-4 text-foreground hover:bg-white/60 hover:border-primary/40 hover:shadow-lg hover:shadow-primary/30 transition-all duration-300 w-full text-left"
                  >
                    Logout
                  </button>
                </>
