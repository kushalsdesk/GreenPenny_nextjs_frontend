    ...
    insights: [
      {
        ...
        action: "Set Budget",
        details: [
          "That's 45% above your 3-month average",
      ...
      },
      {
        ...
        details: [
          "High-yield savings offer: 4.5% APY",
          "Potential earnings: $112.50/year",
        ],
      },
      {
        id: "4",
        ...
        details: [
          "Internet ($79.99) - Due in 3 days",
          "Electric ($89.99) - Due in 5 days",
          "Total: $169.98",
    ...
    insights: [
      {
        ...
        details: [
          "Interest earned: $45.30 this month",
          "Annual projection: $543.60",
        ],
      },
      {
        id: "2",
...
function InsightCard({ insight }: { insight: Insight }) {
  const typeStyles: Record<
    string,
    { gradient: string; icon: string; borderColor: string }
  > = {
    alert: {
    ...
    achievement: {
      gradient:
        "bg-gradient-to-br from-green-50/80 via-green-50/40 to-transparent",
      icon: "🟢",
      borderColor: "border-green-300/50",
    },
    opportunity: {
      gradient:
        "bg-gradient-to-br from-blue-50/80 via-blue-50/40 to-transparent",
      icon: "💡",
      borderColor: "border-blue-300/50",
    },
    reminder: {
      gradient:
        "bg-gradient-to-br from-yellow-50/80 via-yellow-50/40 to-transparent",
      icon: "📅",
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 sm:gap-8">
          <div className="w-full sm:w-auto">
            ...
            <select
              ...
              onChange={(e) =>
                setSelectedAccount(
                  e.target.value as "all" | "checking" | "savings",
                )
              }
              className="w-full sm:w-48 px-4 py-2 bg-white/30 border border-white/40 rounded-lg text-foreground font-medium focus:outline-none focus:border-white/60 transition-all"
            >
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <p className="text-sm text-green-500 font-medium">
                ↑ {metrics.savingsRateChange}%
              </p>
            </div>
            <p className="text-xs text-green-500 pt-2 border-t border-white/20">
              Excellent!
            </p>
          </div>
        </div>
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <p className="text-lg sm:text-xl font-bold text-destructive">
                ${metrics.topCategoryAmount.toLocaleString()}
              </p>
            </div>
            <p className="text-xs text-muted-foreground pt-2 border-t border-white/20">
              {metrics.comparison}
            </p>
          </div>
        </div>
      ...
      <div className="glass-card-glow p-4 sm:p-6">
        ...
        <div className="space-y-4 mb-6">
          <p className="text-sm text-foreground">
            At this rate, you &apos ll save{" "}
            <span className="font-bold text-green-500">$16,800</span> by
            year-end
          </p>
          <p className="text-sm text-foreground">
            Your spending is trending{" "}
            <span className="font-bold">upward by 12%</span>
          </p>
        </div>
